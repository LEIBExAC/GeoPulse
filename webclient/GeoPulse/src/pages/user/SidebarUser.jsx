            ...
            {visible && (
                <div className="sidebar-user d-flex flex-column">
                    ...
                    <Nav defaultActiveKey="/home" className="flex-column sidebar-user__nav">
                        <Nav.Link as={Link} to="/" className="sidebar-user__link">Home</Nav.Link>
                        ...
                        <Nav.Link as={Link} to="/add-tag" className="sidebar-user__link">Add Tag</Nav.Link>
                        ...
                        <Nav.Link as={Link} to="/logout" className="sidebar-user__link">Logout</Nav.Link>
                    </Nav>
                </div>
            )}
